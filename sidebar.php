	...
	<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li><a href="http://localhost/estore/admin/index"><i class="fa fa-tachometer"></i> <span>Home</span></a></li>
										 <li id="menu-academico" ><a href="#"><i class="fa fa-table"></i> <span> Details</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										   ...
										   <li id="menu-academico-avaliacoes" ><a href="http://localhost/estore/admin/user%20details">User Details</a></li>
											<li id="menu-academico-avaliacoes" ><a href="products.html">Watches</a></li>
											<li id="menu-academico-boletim" ><a href="http://localhost/estore/admin/contact">Contact Details</a></li>
										  </ul>
										</li>
										 <li id="menu-academico" ><a href="http://localhost/estore/admin/addproduct"><i class="fa fa-file-text-o"></i> <span>Add Products</span></a></li>
									<li><a href="http://localhost/estore/admin/add%20cetegory"><i class="lnr lnr-pencil"></i> <span>Add Cetegory</span></a></li>
									<li id="menu-academico" ><a href="http://localhost/estore/admin/show%20products"><i class="fa fa-file-text-o"></i> <span>Show All Products</span></a></li>
